...
public class ItemId {
	...
	public static final int hoeCorundumIdDefault = 3603;
	public static final int shovelCorundumIdDefault = 3604;
	...
	public static int hoeCorundumId;
	public static int shovelCorundumId;
